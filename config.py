...
DATABASE_URI = "mongodb+srv://hahema9427:hahema9427@cluster0.3mf49.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
MULTIPLE_DB = False                 
DATABASE_URI2 = "mongodb+srv://..." 

# --- আর্নিং ও মিনি অ্যাপ কনফিগারেশন ---
BOT_USERNAME = "CTGMovieBot"  # আপনার বটের ইউজারনেম ( শুরুতে @ দেবেন না)
WEB_URL = "gorgeous-donetta-nahidcrk-7b84dba9.koyeb.app/view/CTG-Movie-Bot"  # Render থেকে পাওয়া আপনার অ্যাপের লিংক ( শুরুতে https:// দেবেন না)

# আপনার আয়ের ডিরেক্ট অ্যাড লিংক (এখানে Adsterra বা অন্য কোম্পানির ডিরেক্ট অ্যাড লিংক দিন)
DIRECT_AD_LINKS = [
...
# --- আপনার নিজস্ব প্রমোশনাল চ্যানেল লিংকসমূহ ---
CHANNEL_LINK_1 = "https://t.me/+6hvCoblt6CxhZjhl"  # All Movie Link
